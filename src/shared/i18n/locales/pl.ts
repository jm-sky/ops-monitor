...
export default {
  ...
  monitor: {
    title: 'Monitor',
    siteDetail: 'Szczegóły strony',
    addSite: 'Dodaj stronę',
    siteAdded: 'Dodano stronę',
    ...
    filterEnvironmentAll: 'Wszystkie środowiska',
    environmentOptionWithCount: '{environment} ({count})',
    noSearchResults: 'Brak pasujących stron',
    noSearchResultsHint: 'Spróbuj innej frazy wyszukiwania.',
    noIssueResultsHint: 'Brak stron z problemami dla bieżącego wyszukiwania/filtra.',
    clearSearch: 'Wyczyść wyszukiwanie',
    clearFilters: 'Wyczyść filtry',
    activeFilters: 'Aktywne filtry',
    activeFilterQuery: 'Wyszukiwanie: "{query}"',
    activeFilterIssues: 'Tylko problemy',
    activeFilterEnvironment: 'Środowisko: {environment}',
    activeFiltersSummary: 'Aktywne filtry: {filters}',
    searchShortcutHint: 'Naciśnij Esc, aby wyczyścić wyszukiwanie',
    resultsSummary: '{sites} stron w {groups} grupach',
    environmentResetInfo: 'Filtr środowiska został zresetowany. "{environment}" nie jest już dostępne.',
    noSites: 'Brak skonfigurowanych stron',
    noSitesHint: 'Dodaj stronę, aby rozpocząć monitorowanie.',
    siteNotFoundTitle: 'Strona nie została znaleziona',
    siteNotFoundDescription: 'Strona, którą próbujesz otworzyć, nie istnieje albo adres URL jest nieprawidłowy.',
    goBackToMonitor: 'Wróć',
    ungrouped: 'Bez grupy',
    loadError: 'Nie udało się wczytać stron',
    createError: 'Nie udało się utworzyć strony',
    updateError: 'Nie udało się zaktualizować strony',
    deleteError: 'Nie udało się usunąć strony',
    editSite: 'Edytuj stronę',
    deleteSite: 'Usuń stronę',
    deleteConfirmDescription: 'Spowoduje to trwałe usunięcie strony i wszystkich jej snapshotów.',
    deleted: 'Strona usunięta',
    siteEnabled: 'Strona włączona',
    siteDisabled: 'Strona wyłączona',
    pollNow: 'Sprawdź teraz',
    pollComplete: 'Sprawdzanie zakończone',
    pollError: 'Sprawdzanie nieudane',
    health: 'Zdrowie',
    system: 'System',
    ssl: 'SSL',
    sslDaysRemaining: 'Dni do wygaśnięcia',
    sslExpiresAt: 'Wygasa',
    sslIssuer: 'Wystawca',
    sslSubject: 'Podmiot',
    sslEndpointResponse: 'Szczegóły certyfikatu SSL',
    ...
    status: {
      ...
      expiringSoon: 'Bliski termin ważności',
      ok: 'OK',
    ...
    fields: {
      ...
      environment: 'Środowisko (opcjonalnie)',
      ip: 'Adres IP (opcjonalnie)',
      tags: 'Tagi (opcjonalnie)',
      healthUrl: 'URL health',
      systemUrl: 'URL system',
      sslCheckUrl: 'URL do sprawdzania SSL',
    ...
    removeTag: 'Usuń tag',
    alerts: {
      title: 'Kanały alertów',
      addChannel: 'Dodaj kanał',
      editChannel: 'Edytuj kanał alertów',
      loadError: 'Nie udało się wczytać kanałów',
      updateError: 'Nie udało się zaktualizować kanału',
      testError: 'Test nieudany',
      deleteConfirm: 'Usunąć kanał?',
      deleteConfirmDescription: 'Tej operacji nie można cofnąć.',
      deleted: 'Kanał usunięty',
      created: 'Kanał dodany',
      updated: 'Kanał zaktualizowany',
      deleteError: 'Nie udało się usunąć kanału',
      createError: 'Nie udało się utworzyć kanału',
      test: 'Test',
      noChannels: 'Brak skonfigurowanych kanałów alertów',
      noChannelsHint: 'Dodaj kanał, aby otrzymywać alerty o zmianach statusu stron.',
      fields: {
        name: 'Nazwa',
        type: 'Typ',
      ...
      filters: {
        title: 'Filtry',
        hint: 'Pusty wybór oznacza brak ograniczenia.',
        alertTypes: 'Typy alertów',
        alertTypesHint: 'Brak wyboru = wszystkie typy.',
        minSeverity: 'Waga health',
        severity: {
          degraded: 'Degraded + Failed',
          failed: 'Tylko Failed',
        },
        sites: 'Strony',
        sitesHint: 'Brak wyboru = wszystkie strony (łączone z tagami przez OR).',
        noSites: 'Brak skonfigurowanych stron.',
        tags: 'Tagi',
        noTags: 'Brak tagów w żadnej ze stron.',
        quietHours: 'Godziny ciszy',
        quietStart: 'Początek',
        quietEnd: 'Koniec',
        timezone: 'Strefa czasowa',
        cooldown: 'Powtórz alert po (minuty)',
        cooldownPlaceholder: 'puste = wyłączone',
        cooldownHint: 'Jeśli status pozostaje zły, wyślij ponownie po N minutach. Puste = bez powtórzeń.',
        summary: {
          sites: '{n} stron',
          tags: '{n} tagów',
          quiet: 'cisza {start}–{end}',
          cooldown: 'powtórka {n}m',
        },
      },
      log: {
