...
export default {
  ...
  monitor: {
    ...
    environmentOptionWithCount: '{environment} ({count})',
    noSearchResults: 'No matching sites',
    noSearchResultsHint: 'Try a different search phrase.',
    noIssueResultsHint: 'No sites with issues for the current search/filter.',
    clearSearch: 'Clear search',
    clearFilters: 'Clear filters',
    activeFilters: 'Active filters',
    activeFilterQuery: 'Search: "{query}"',
    activeFilterIssues: 'Issues only',
    activeFilterEnvironment: 'Environment: {environment}',
    activeFiltersSummary: 'Active filters: {filters}',
    searchShortcutHint: 'Press Esc to clear search',
    resultsSummary: '{sites} sites in {groups} groups',
    environmentResetInfo: 'Environment filter reset. "{environment}" is no longer available.',
    noSites: 'No sites configured',
    noSitesHint: 'Add a site to start monitoring.',
    siteNotFoundTitle: 'Site not found',
    siteNotFoundDescription: 'The site you are trying to open does not exist or the URL is invalid.',
    goBackToMonitor: 'Go back',
    ungrouped: 'Ungrouped',
    ...
    deleteConfirmDescription: 'This will permanently delete the site and all its snapshots.',
    ...
    system: 'System',
    ssl: 'SSL',
    sslDaysRemaining: 'Days remaining',
    sslExpiresAt: 'Expires',
    sslIssuer: 'Issuer',
    sslSubject: 'Subject',
    sslEndpointResponse: 'SSL certificate details',
    ...
    alerts: {
      ...
      test: 'Test',
      noChannels: 'No alert channels configured',
      noChannelsHint: 'Add a channel to receive alerts when site status changes.',
      fields: {
        name: 'Name',
        type: 'Type',
      ...
      filters: {
        title: 'Filters',
        hint: 'Empty selections mean no restriction.',
        alertTypes: 'Alert types',
        alertTypesHint: 'No selection = all types.',
        minSeverity: 'Health severity',
        severity: {
          degraded: 'Degraded + Failed',
          failed: 'Failed only',
        },
        sites: 'Sites',
        sitesHint: 'No selection = all sites (combined with tags as OR).',
        noSites: 'No sites configured yet.',
        tags: 'Tags',
        noTags: 'No tags found across sites.',
        quietHours: 'Quiet hours',
        quietStart: 'Start',
        quietEnd: 'End',
        timezone: 'Timezone',
        cooldown: 'Re-alert cooldown (minutes)',
        cooldownPlaceholder: 'leave empty = off',
        cooldownHint: 'If status stays bad, re-send after N minutes. Empty = no repeats.',
        summary: {
          sites: '{n} sites',
          tags: '{n} tags',
          quiet: 'quiet {start}–{end}',
          cooldown: 'repeat {n}m',
        },
      },
      log: {
  ...
  privacy: {
    ...
    dataCollection: {
      ...
      description: 'Ops Monitor application collects the following data:',
      items: {
        account: 'Account data: email, full name (required to create an account)',
        gear: 'Monitoring data: services, endpoints, status snapshots, and related metadata (stored in database)',
  ...
  terms: {
    ...
    acceptance: {
      ...
      description: 'By using the Ops Monitor application, you accept these terms of use. If you do not agree with any of the following terms, you should not use the service.',
    },
    account: {
      title: 'User Account',
  ...
  landing: {
    title: 'Ops Monitor',
    subtitle: 'Monitor your infrastructure health, incidents, and system status in one place',
    welcomeBack: 'Welcome back, {name}!',
    feature1: {
      title: 'Organize',
      description: 'Track all monitored services and endpoints in one operational view',
    },
    feature2: {
      title: 'Track',
    ...
    feature3: {
      title: 'Prepare',
      description: 'Stay ready for incidents with real-time operational visibility',
    },
    login: 'Log In',
    register: 'Sign Up',
    footer: 'Start monitoring your systems today',
    localData: {
      title: 'You have monitoring data in your browser',
      description: 'Log in or register to synchronize your data',
    },
    stats: {
      totalUsers: 'Total Users',
      totalContainers: 'Total Services',
  ...
  notFound: {
    ...
    goToContainers: 'Go to Monitoring',
  ...
  about: {
    title: 'About Ops Monitor',
    subtitle: 'A comprehensive web application for monitoring infrastructure, services, and operational health',
    tableOfContents: {
      title: 'Table of Contents',
    },
    overview: {
      title: 'Overview',
      description: 'Ops Monitor is a full-stack application designed for operations teams and administrators. It combines an intuitive front-end interface with a robust backend to provide secure multi-user monitoring with centralized visibility across systems.',
    },
    capabilities: {
      ...
      organization: 'Advanced Visibility - Unified service and endpoint health tracking across your environment',
    ...
    coreFeatures: {
      ...
      containers: {
        ...
        multiple: 'Multiple monitored targets (services, hosts, endpoints, and custom checks)',
        hierarchical: 'Logical grouping - organize checks by environment, team, or service domain',
        colors: 'Visual distinction - assign colors and labels for quick identification',
        metadata: 'Monitoring metadata - type, owner, SLA level, and status labels',
        cycle: 'Dependency safety - detect and avoid invalid monitoring relationships',
      },
      items: {
        title: 'Incident & Check Management',
        rich: 'Rich check data: name, type, severity, status, ownership, tags, notes, and timestamps',
        categorization: 'Smart categorization - group checks by infrastructure layer, service type, and incident domain',
        status: 'Status tracking - monitor states such as healthy, degraded, failed, and maintenance',
        priority: 'Priority levels - low, medium, high, and critical',
        expiration: 'SLA tracking - monitor response windows and escalation deadlines',
      },
      analytics: {
        title: 'Analytics & Insights',
        weight: 'Health analytics - aggregate service status, incident trends, and uptime distribution across groups',
        readiness: 'Readiness indicators - operational health score based on service and check status',
        charts: 'Charts and summaries - visual breakdown of status and incident categories',
        statistics: 'Operational statistics - count checks and incidents by status, category, or priority',
      },
      search: {
        title: 'Search & Filtering',
        smart: 'Smart search - find services, checks, and incidents by name, tag, or notes',
        filtering: 'Multi-criteria filtering - filter by environment, status, severity, owner, or service',
        sorting: 'Sorting options - sort by name, status, last change, severity, or uptime',
        expired: 'Highlight active incidents - visual warnings for failing or recently degraded systems',
      },
      importExport: {
        title: 'Import/Export',
        json: 'JSON export/import - full data backup and restore',
        markdown: 'AI-ready markdown export - export monitoring context in a structured format for AI analysis and incident triage',
  ...
  aiContext: {
    title: 'AI Context',
    subtitle: 'Short description of Ops Monitor in Markdown format for AI assistants like ChatGPT',
    card: {
      title: 'Copy Context to Clipboard',
      description: 'Click the button below to copy the context description. You can then paste it into ChatGPT or other AI assistants to provide context about Ops Monitor.',
    },
