...
import ItemImagePreviewOverlayButton from '@/modules/gear/components/ItemImagePreviewOverlayButton.vue'
import type { ICatalogueItemImage } from '@/modules/gear/types/catalogueItemImage.types'

const { images } = defineProps<{
  images: ICatalogueItemImage[]
}>()
...
const activeImage = computed<ICatalogueItemImage | null>(() => {
